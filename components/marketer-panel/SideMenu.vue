        ...
        <nav class="side_nav flex flex-col gap-4 p-2 rounded-2xl shadow-2xl" v-show="sideMenuOpen">
            <ul class="flex flex-col p-1 gap-1 w-full h-full flex-grow text-sm" v-clickaway:sidenav_toggler="menuOnBlur">
                <li class="flex w-full">
                    <nuxt-link class="flex items-center gap-2 p-2 rounded-xl w-full" to="/marketer-panel/dashboard">
                ...
                <li class="flex w-full">
                    <nuxt-link class="flex items-center gap-2 p-2 rounded-xl w-full" to="/marketer-panel/customers">
                        <img src="/icons/admin/Users2.svg" class="menu_icon" width="24" />
                        <span>لیست مشتریان</span>
                    </nuxt-link>
                </li>
                <li class="flex w-full">
                    <nuxt-link class="flex items-center gap-2 p-2 rounded-xl w-full" to="/marketer-panel/courses">
                        <img src="/icons/admin/Play.svg" class="menu_icon" width="24" />
                        <span>دوره های فعال</span>
                    </nuxt-link>
                </li>
                <li class="flex w-full">
                    <nuxt-link class="flex items-center gap-2 p-2 rounded-xl w-full" to="/marketer-panel/commissions">
                        <img src="/icons/admin/SackDollar.svg" class="menu_icon" width="24" />
                        <span>کمیسیون ها</span>
                    </nuxt-link>
                </li>
                <li class="flex w-full">
                    <nuxt-link class="flex items-center gap-2 p-2 rounded-xl w-full" to="/marketer-panel/commission-payments">
                        <img src="/icons/admin/Receipt.svg" class="menu_icon" width="24" />
                        <span>تاریخچه پرداختی های کمیسیون</span>
                    </nuxt-link>
                </li>
            </ul>
