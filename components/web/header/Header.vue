...
<template>
    <div class="fixed top-0 flex items-center justify-center py-2 w-screen shadow-xl z-20 bg-truegray-50">
        <header class="flex items-center gap-4 lg:gap-2 px-4 md:px-8 w-full max-w-screen-2xl">
            <button class="flex justify-center items-center p-3 rounded-2xl bg-white shadow-lg lg:hidden" @click="toggleMenu()">
                <Icon class="w-6 h-6 bg-gray-800" size="24px" folder="icons/new" name="Category" />
            </button>
            ...
            <div class="flex items-center mr-auto flex-shrink-0">
                ...
                <div class="p-2 my-2 rounded-xl bg-warmgray-200" v-if="loading">
