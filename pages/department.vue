            ...
            <div class="flex items-center justify-center w-full max-w-screen-xl">
                ...
                <div class="relative flex flex-col items-start gap-4 flex-grow">
                    ...
                    <p class="text-white font-bold w-full">
                        اگر نمیدونی چه حوزه ای برات مناسب تره ، کافیه جواب سوالایی که برات میفرستیم رو بدی تا ما بهت یه نقشه راه بدیم و بگیم تو چه حوزه ای کار کنی که
                        کارتو خیلی جلو میندازه!
                    </p>
