    ...
    <main class="dashboard_body flex flex-col gap-4 md:p-4 md:py-1">
        <div class="flex flex-wrap justify-between items-center gap-4">
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-2xl"><b>گروه سوالات</b></h1>
            </div>
            <nuxt-link
                to="/admin/roadmap-question-category/create"
                class="orange_gradient_v rounded-xl p-2 px-4 w-max hover:shadow-md"
                v-if="checkPermissions(['admin.roadmap-question-category.add'], userPermissions)"
            >
                گروه سوال جدید
            </nuxt-link>
        </div>
        ...
        <Table
            ...
            :total="total"
            :pageTotal="pageTotal"
            :pageUrl="`/admin/roadmap-question-category/:page?search=${search}`"
                ...
                <td>
                    <div class="flex items-center gap-1">
                        <router-link
                            ...
                            title="Edit"
                            :to="`/admin/roadmap-question-category/edit/${record._id}`"
                            v-if="checkPermissions(['admin.roadmap-question-category.edit'], userPermissions)"
                        >
                        ...
                        <button
                            ...
                            v-if="checkPermissions(['admin.roadmap-question-category.delete'], userPermissions)"
                        >
        ...
        <DeleteDialog
            ...
            url="/api/admin/roadmap-question-category"
        />
    </main>
</template>
...
export default {
    layout: "admin",
    head() {
        return { title: "گروه سوال ها - گروه آموزشی پرتقال" };
    },
    ...
    methods: {
        async getTableData(data = {}) {
            ...
            let url = `/api/admin/roadmap-question-category`;
            let headers = {};
            if (process.server) {
