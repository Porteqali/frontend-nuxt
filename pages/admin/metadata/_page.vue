    ...
    <main class="dashboard_body flex flex-col gap-4 md:p-4 md:py-1">
        <div class="flex flex-wrap justify-between items-center gap-4">
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-2xl"><b>متادیتا صفحات</b></h1>
            </div>
            <nuxt-link
                to="/admin/metadata/create"
                class="orange_gradient_v rounded-xl p-2 px-4 w-max hover:shadow-md"
                v-if="checkPermissions(['admin.metadata.add'], userPermissions)"
            >
                صفحه جدید
            </nuxt-link>
        </div>
        ...
        <Table
            ...
            :total="total"
            :pageTotal="pageTotal"
            :pageUrl="`/admin/metadata/:page?search=${search}`"
                ...
                <td>
                    <div class="flex items-center gap-1">
                        <router-link
                            ...
                            title="Edit"
                            :to="`/admin/metadata/edit/${record._id}`"
                            v-if="checkPermissions(['admin.metadata.edit'], userPermissions)"
                        >
...
export default {
    layout: "admin",
    head() {
        return { title: "متادیتا صفحات - گروه آموزشی پرتقال" };
    },
