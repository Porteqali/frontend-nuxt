    ...
    <main class="dashboard_body flex flex-col gap-4 md:p-4 md:py-1">
        <div class="flex flex-wrap justify-between items-center gap-4">
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-2xl"><b>پیام های تماس با ما</b></h1>
            </div>
            <!--  -->
        </div>
        ...
        <Table
            ...
            :total="total"
            :pageTotal="pageTotal"
            :pageUrl="`/admin/contact-requests/:page?search=${search}`"
        ...
        >
            <template v-slot:tbody="{ record, index }">
                ...
                <td>
                    <p>{{ record.message.length > 60 ? record.message.substr(0, 60) + "..." : record.message }}</p>
                </td>
                <td>
                ...
                <td>
                    <div class="flex items-center gap-1">
                        <router-link
                            ...
                            title="مشاهده"
                            :to="`/admin/contact-requests/details/${record._id}`"
                            v-if="checkPermissions(['admin.contact-requests.view'], userPermissions)"
                        >
                        ...
                        <button
                            ...
                            v-if="checkPermissions(['admin.contact-requests.delete'], userPermissions)"
                        >
...
export default {
    layout: "admin",
    head() {
        return { title: "پیام های تماس با ما - گروه آموزشی پرتقال" };
    },
    ...
    methods: {
        async getTableData(data = {}) {
            ...
            let url = `/api/admin/contact-requests`;
            let headers = {};
            if (process.server) {
