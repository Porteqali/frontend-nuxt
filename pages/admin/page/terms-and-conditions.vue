...
<template>
    <main class="dashboard_body flex flex-col gap-4 md:p-4 md:py-1">
        <div class="flex flex-wrap md:flex-nowrap items-center gap-2">
            ...
            <h1 class="text-2xl"><b>ویرایش صفحه قوانین و مقررات</b></h1>
        </div>
...
export default {
    layout: "admin",
    head() {
        return { title: "ویرایش صفحه قوانین و مقررات - گروه آموزشی پرتقال" };
    },
    components: {
        Editor,
    },
    ...
    methods: {
        async loadInfo(data = {}) {
            let url = `/api/admin/staticPages/terms_and_conditions`;
            let headers = {};
            if (process.server) {
        ...
        async save() {
            ...
            let url = encodeURI(`/api/admin/staticPages/terms_and_conditions`);
            await axios
                .put(url, {
                    text: this.body,
                })
