    ...
    <main class="dashboard_body flex flex-col gap-4 md:p-4 md:py-1">
        <div class="flex flex-wrap justify-between items-center gap-4">
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-2xl"><b>سوالات نقشه راه</b></h1>
            </div>
            <nuxt-link
                to="/admin/roadmap-questions/create"
                class="orange_gradient_v rounded-xl p-2 px-4 w-max hover:shadow-md"
                v-if="checkPermissions(['admin.roadmap-questions.add'], userPermissions)"
            >
                سوال جدید
            </nuxt-link>
        </div>
        ...
        <Table
            ...
            :total="total"
            :pageTotal="pageTotal"
            :pageUrl="`/admin/roadmap-questions/:page?search=${search}`"
                ...
                <td>
                    <div class="flex items-center gap-1">
                        <router-link
                            ...
                            title="Edit"
                            :to="`/admin/roadmap-questions/edit/${record._id}`"
                            v-if="checkPermissions(['admin.roadmap-questions.edit'], userPermissions)"
                        >
                        ...
                        <button
                            ...
                            v-if="checkPermissions(['admin.roadmap-questions.delete'], userPermissions)"
                        >
        ...
        <DeleteDialog
            ...
            url="/api/admin/roadmap-questions"
        />
    </main>
</template>
...
export default {
    layout: "admin",
    head() {
        return { title: "سوالات نقشه راه - گروه آموزشی پرتقال" };
    },
    ...
    methods: {
        async getTableData(data = {}) {
            ...
            let url = `/api/admin/roadmap-questions`;
            let headers = {};
            if (process.server) {
