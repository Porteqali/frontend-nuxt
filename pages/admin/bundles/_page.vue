    ...
    <main class="dashboard_body flex flex-col gap-4 md:p-4 md:py-1">
        <div class="flex flex-wrap justify-between items-center gap-4">
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-2xl"><b>لیست باندل های نقشه راه</b></h1>
            </div>
            <nuxt-link
                to="/admin/bundles/create"
                class="orange_gradient_v rounded-xl p-2 px-4 w-max hover:shadow-md"
                v-if="checkPermissions(['admin.bundles.add'], userPermissions)"
            >
                باندل جدید
            </nuxt-link>
        </div>
        ...
        <Table
            ...
            :total="total"
            :pageTotal="pageTotal"
            :pageUrl="`/admin/bundles/:page?search=${search}`"
                ...
                <td>
                    <div class="flex items-center gap-1">
                        <router-link
                            ...
                            title="Edit"
                            :to="`/admin/bundles/edit/${record._id}`"
                            v-if="checkPermissions(['admin.bundles.edit'], userPermissions)"
                        >
                        ...
                        <router-link
                            ...
                            title="سرفصل ها"
                            :to="`/admin/bundles/courses/${record._id}`"
                            v-if="checkPermissions(['admin.bundles.edit'], userPermissions)"
                        >
                        ...
                        <button
                            ...
                            v-if="checkPermissions(['admin.bundles.delete'], userPermissions)"
                        >
