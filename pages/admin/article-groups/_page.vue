    ...
    <main class="dashboard_body flex flex-col gap-4 md:p-4 md:py-1">
        <div class="flex flex-wrap justify-between items-center gap-4">
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-2xl"><b>گروه مقاله ها</b></h1>
            </div>
            <nuxt-link
                to="/admin/article-groups/create"
                class="orange_gradient_v rounded-xl p-2 px-4 w-max hover:shadow-md"
                v-if="checkPermissions(['admin.article-groups.add'], userPermissions)"
            >
                گروه مقاله جدید
            </nuxt-link>
        </div>
        ...
        <Table
            ...
            :total="total"
            :pageTotal="pageTotal"
            :pageUrl="`/admin/article-groups/:page?search=${search}`"
                ...
                <td>
                    <div class="flex items-center gap-1">
                        <router-link
                            ...
                            title="Edit"
                            :to="`/admin/article-groups/edit/${record._id}`"
                            v-if="checkPermissions(['admin.article-groups.edit'], userPermissions)"
                        >
                        ...
                        <button
                            ...
                            v-if="checkPermissions(['admin.article-groups.delete'], userPermissions)"
                        >
...
export default {
    layout: "admin",
    head() {
        return { title: "گروه مقاله ها - گروه آموزشی پرتقال" };
    },
    ...
    methods: {
        async getTableData(data = {}) {
            ...
            let url = `/api/admin/article-groups`;
            let headers = {};
            if (process.server) {
