    ...
    <main class="dashboard_body flex flex-col gap-4 md:p-4 md:py-1">
        <div class="flex flex-wrap justify-between items-center gap-4">
            <div class="flex flex-wrap md:flex-nowrap items-center gap-2">
                <nuxt-link to="/marketer-panel"><img class="opacity-75" src="/icons/admin/Home.svg" width="20" /></nuxt-link>
                <img src="/icons/Arrow.svg" width="12" style="transform: rotate(90deg)" />
                <h1 class="text-2xl"><b>دوره های فعال</b></h1>
            </div>
            <!--  -->
        </div>
        ...
        <Table
            ...
            :total="total"
            :pageTotal="pageTotal"
            :pageUrl="`/marketer-panel/courses/:page?search=${search}`"
        ...
        >
            <template v-slot:tbody="{ record }">
                ...
                <td>
                    <span class="title">مقدار کمیسیون:</span>
...
export default {
    layout: "marketerPanel",
    head() {
        return { title: "دوره های فعال - گروه آموزشی پرتقال" };
    },
    components: {
        Table,
        DeleteDialog,
    ...
    methods: {
        async getTableData(data = {}) {
            ...
            let url = `/api/marketer-panel/courses/`;
            let headers = {};
            if (process.server) {
