...
<template>
    <main role="main" class="flex flex-col items-center gap-16 lg:gap-24 max-w-screen-2xl w-full mt-6 md:mt-10">
        <section class="relative flex flex-wrap md:flex-nowrap items-start md:items-center justify-between gap-8 px-4 md:px-8 w-full">
            <div class="board w-full max-w-screen-lg bg-warmgray-600 flex flex-col gap-10 p-6 md:p-12 md:pl-52 flex-shrink-0">
                <strong class="text-xs text-warmgray-50 font-normal -mb-12">حاضری برای خودت سرمایه گذاری کنی؟</strong>
                <h1 class="flex flex-col gap-4 text-warmgray-100 w-full max-w-screen-lg">
                ...
                <form class="search_box flex items-center gap-4 p-2 rounded-2xl shadow-lg bg-white" @submit="goToSearchPage($event)">
            ...
            <div class="relative flex items-center justify-center flex-shrink -mt-28 md:-mt-0 -mr-0 md:-mr-96">
                <img
                    class="portalGirl relative w-screen max-w-3xl md:max-w-2xl xl:max-w-3xl z-10"
                    loading="lazy"
                    src="/pages/home/3.png"
...
import DepartmentSection from "~/components/web/home2/Department.section";
import MostViewedCoursesSection from "~/components/web/home2/MostViewedCourses.section";
import TestimonialSection from "~/components/web/home2/Testimonial.section";
import BlogSection from "~/components/web/home2/Blog.section";
import NewsSection from "~/components/web/home2/News.section";
import NewsletterSection from "~/components/web/home2/Newsletter.section";
